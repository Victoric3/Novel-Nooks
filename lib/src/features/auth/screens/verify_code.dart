...
import 'package:flutter_ebook_app/src/features/auth/blocs/verify_code.dart';
            ...
            Container(
              ...
              child: Container(
                ...
                child: Consumer(builder: (context, ref, child) {
                  ...
                  final VerifyCode _verify = VerifyCode();
                  ...
                  void _verifyCode() async {
                    ...
                    _verify.collectFormData({"token": code});
                    print('status:');
                    print(status);
                    if (status == "temporary user" || statusCode == 404) {
                      await _verify.confirmEmail(context, ref);
                    } else {
                      await _verify.verifyUnUsualsignIn(context, ref);
                    }
                  }
                  ...
                  void _resendCode() async {
                    ...
                    await _verify.resendverificationtoken(context, ref);
                  }
                  ...
                  return Column(
                    children: [
                      ...
                      const SizedBox(height: 20),
                      InkWell(
                        onTap: _isResendButtonDisabled ? null : _resendCode,
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            const IconButton(
